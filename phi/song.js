...
chicken$in:{
    composer:'SWIN-S / laman29',
    track:[-2,-1,0,1,1,3,3.5,4,4.5,5,5.5,6,7,7.5,8,9,10,11,11,13, 14,15,15,16,17,17,19,19.5,20,20.5,21,21.5,22,23,23.5,24, ],
    map  :[1,2.5,1.5,1,3,2,3,3,3,1.5,2.5,2.5,1,2,2,1,2.5,1.5,3,1, 2.5,1.5,3,2.5,1,2,1,2,3,2,1,2,3,1,2,3,                   ],
    offset:-0.81,
    beat:0.28037,
    current:0.25,
    url:'../draw32/jntm_full.mp3'
